...
const installCmd = `npm install @arlopass/react-ui`;

const quickExample = `import { Chat, StreamingText, Message } from "@arlopass/react-ui";
...
const primitives = [
  ...
  },
  {
    ...
    description:
      "Renders content conditionally based on the Arlopass extension connection state (connected / disconnected / not installed).",
  },
];
  ...
  return (
    <Stack gap="lg">
      <div>
        ...
        <Text c="dimmed" mt={4}>
          Headless primitives and copy-paste blocks for building AI chat
          interfaces
        </Text>
      </div>

      <Text>Arlopass ships two complementary layers for UI development:</Text>
      ...
      <Text>
        ...
        <InlineCode>Chat.Root</InlineCode> manages conversation state internally
      ...
      <Callout type="info" title="Architecture: Primitives + Blocks">
        <Text fz="sm">
          ...
          <InlineCode>@arlopass/react-ui</InlineCode>) are installed from npm
          and are unstyled. They handle behaviour, accessibility, and state —
          you supply the markup and CSS.
        </Text>
        <Text fz="sm" mt={4}>
          <strong>Blocks</strong> (<InlineCode>@arlopass/ui</InlineCode>) are
          ...
          freely. See <NavLink id="components/registry">Block registry</NavLink>
          .
        </Text>
      </Callout>
      ...
      <Text>
        All primitives are exported from{" "}
        <InlineCode>@arlopass/react-ui</InlineCode>. Each is a compound
        component with dot-notation sub-components (e.g.{" "}
        <InlineCode>Chat.Root</InlineCode>,{" "}
        <InlineCode>Chat.Messages</InlineCode>).
      </Text>
      ...
      <Text>
        ...
        their rendered DOM elements so you can style states with plain CSS — no
        JavaScript required.
      </Text>
