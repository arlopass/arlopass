...
const sdkMachineCodes = [
  ...
  },
  {
    ...
    type: "SDK",
    description: "Chat operation attempted without selecting a provider first.",
  },
  {
...
const retryableExample = `if (error instanceof ArlopassSDKError && error.retryable) {
  await retry();
}`;
  ...
  return (
    <Stack gap="lg">
      ...
      <Text>
        ...
        <InlineCode>ArlopassSDKError</InlineCode> (or a subclass). Errors carry
      ...
      <Text>
        All error subclasses inherit these properties from{" "}
        <InlineCode>ArlopassSDKError</InlineCode>.
      </Text>
      <ApiTable data={errorProperties} title="ArlopassSDKError" />

      {/* SDK machine codes */}
      <Divider />
      <Title order={3}>SDK machine codes</Title>
      <Text>
        Codes prefixed with <InlineCode>ARLOPASS_SDK_</InlineCode> originate in
        the client SDK.
      </Text>
      ...
      <Text>
        Codes prefixed with <InlineCode>ARLOPASS_</InlineCode> or{" "}
        <InlineCode>ARLOPASS_PROTOCOL_</InlineCode> originate in the protocol
        layer or extension.
      </Text>
      ...
      <Text>
        Every error has a <InlineCode>retryable</InlineCode> boolean. Use it to
        decide whether to surface a retry button or fail permanently.
      </Text>
