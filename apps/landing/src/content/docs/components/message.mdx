...
<ApiTable props={[
  { name: "message", type: "TrackedChatMessage", required: true, description: "The message object to display." },
...
<ApiTable props={[
  { name: "data-role", type: '"user" | "assistant" | "system"', description: "Set on Message.Root. The message role." },
  { name: "data-status", type: '"pending" | "sent" | "error"', description: "Set on Message.Root. Delivery status of the message." }
]} />
