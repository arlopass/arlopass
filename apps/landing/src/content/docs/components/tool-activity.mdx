...
<ApiTable props={[
  { name: "toolCall", type: "ToolCallInfo", required: true, description: "The tool call to display." },
...
<ApiTable props={[
  { name: "toolCall", type: "ToolCallInfo", required: true, description: "The tool call whose result to display." }
]} />
...
<ApiTable props={[
  ...
  { name: "data-status", type: '"pending" | "running" | "complete" | "error"', description: "Set on ToolActivity.Call and ToolActivity.Result. Status of the individual tool call." }
]} />
