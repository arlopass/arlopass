...
See [Web SDK vs React SDK](/docs/concepts/web-sdk-vs-react) for when to use each SDK, or [Hooks Reference](/docs/reference/react/hooks) for the full list of available hooks and their return types.
</Callout>
