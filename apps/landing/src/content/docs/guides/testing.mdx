...
keywords: ["testing", "mock transport", "vitest", "testing-library", "streaming", "error simulation", "react"]
schema: "Article"
---
...
import { createMockTransport, MockArlopassProvider } from "@arlopass/react/testing";
...
import { mockWindowArlopass, cleanupWindowArlopass } from "@arlopass/react/testing";
import { createMockTransport } from "@arlopass/react/testing";
...
<Callout type="tip" title="Related">
  See the [Testing API reference](/docs/reference/react-sdk/testing) for complete `createMockTransport` options, or the [ArlopassClient reference](/docs/reference/web-sdk/arlopass-client) for web SDK testing patterns.
</Callout>
