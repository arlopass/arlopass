...
keywords: ["guards", "gates", "connection gate", "provider gate", "chat ready", "conditional rendering", "react"]
schema: "Article"
---
...
<Callout type="tip" title="Related">
  See the [Guards API reference](/docs/reference/react-sdk/guards) for complete props documentation, or the [Error Handling guide](/docs/guides/error-handling) for error-specific patterns.
</Callout>
