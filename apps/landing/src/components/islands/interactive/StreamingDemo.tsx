...
export default function StreamingDemo() {
  const { prompt, setPrompt, preview, run, doStream, sid, busy, isBusy } =
    useInteractive();
  ...
  return (
    <Stack gap="lg">
      ...
      <Text c="dimmed">
        Send a message and watch the response stream in real-time, chunk by
        chunk.
      </Text>
      ...
      {!sid && (
        <Card withBorder p="sm">
          <Text size="sm" c="dimmed">
            Connect and select a provider first — use the Connection or
            Playground page.
          </Text>
        </Card>
      )}
