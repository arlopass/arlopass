...
- Connect to Amazon Bedrock via AWS credentials
- Support for Bedrock-hosted models (Claude, Llama, Mistral, Titan, etc.)
- Streaming and non-streaming chat completions
- IAM role and session-based authentication
